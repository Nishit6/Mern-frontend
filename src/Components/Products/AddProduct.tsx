...
const AddProduct: React.FC<{}> = (props) => {
    ...
    async function addProducts(productName: string, productDesc: string, productImg: string, productQuantity: number, productPrice: string) {
        ...
        await axios.post('https://mern-backend-theta.vercel.app/products', { name: productName, desc: productDesc, img: productImg, quantity: productQuantity, price: productPrice })
            .then((response) => {
